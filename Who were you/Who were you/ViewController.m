...
//      [navigationBar setBackgroundImage:[UIImage imageNamed:@"NavigationBg2.png"] forBarMetrics:UIBarMetricsDefault];
...
//        if(myImage.size.width > self.mUIImageView.bounds.size.width || myImage.size.height > self.mUIImageView.bounds.size.height)
//            [mUIImageView setImage:[UIImage imageWithImage:myImage scaledToSize:self.mUIImageView.bounds.size]];
//        else
//            [mUIImageView setImage:myImage];
...
-(IBAction)find:(id)sender
{
    ...
    if(firstName.length==0){
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Who were you" message:@"Please enter your first name" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil];
        [alert show];
        return;
    }
    ...
    if(lastName.length==0){
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Who were you" message:@"Please enter your last name" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil];
        [alert show];
        return;
    }

    if(dobTextField.text.length==0){
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Who were you" message:@"Please select your date of birth" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil];
        [alert show];
        return;
    }
    
    if(!mUIImageView.image){
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Who were you" message:@"Please select your photo" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil];
        [alert show];
        return;
    }


    PastLife *mPastLife=[[PastLife alloc] init];
